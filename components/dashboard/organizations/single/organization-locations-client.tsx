...
import type { OrganizationWithRelations, SerializedLocationWithConnection } from "@/lib/prisma-types"
import type { PaginationMeta } from "@/lib/api-types"

interface OrganizationLocationsClientProps {
...
/**
 * OrganizationLocationsClient - Client Component
 * 
 * Displays Google My Business locations managed by the organization.
 * Renders cards with pagination support.
 * 
 * Architecture:
 * - Client Component: Receives data from OrganizationLocationsServer
 * - Handles UI rendering and pagination
 * - Uses useTranslations for i18n (Client Component API)
 */
export function OrganizationLocationsClient({ 
  locations, 
  pagination, 
  organization
}: OrganizationLocationsClientProps) {
  const t = useTranslations("backoffice.organizations.detail.locations")
