...
interface UserDetailTabsProps {
  defaultTab: "info" | "accounts" | "locations" | "sessions"
  children: React.ReactNode
}

const VALID_TABS = ["info", "accounts", "locations", "sessions"] as const
type ValidTab = typeof VALID_TABS[number]

/**
 * UserDetailTabs - Client Component for URL-synchronized tabs
 * 
 * Uses hybrid navigation: router.push() when page param exists, replaceState() otherwise.
 */
export function UserDetailTabs({ defaultTab, children }: UserDetailTabsProps) {
  ...
  return (
    <Tabs value={currentTab} onValueChange={handleTabChange} className="w-full">
      <TabsList className="w-full justify-start">
        ...
        <TabsTrigger value="accounts">{t("detail.tabs.accounts")}</TabsTrigger>
